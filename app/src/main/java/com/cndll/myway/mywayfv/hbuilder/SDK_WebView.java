...
class WebviewModeListener implements ICoreStatusListener {
    ...
    public void onCoreInitEnd(ICore coreHandler) {
        // 设置单页面集成的appid
        String appid = "H50CFBACD";
        // 单页面集成时要加载页面的路径，可以是本地文件路径也可以是网络路径
        String url = "file:///android_asset/apps/H50CFBACD/index.html";
        /*String url = "/app/assets/apps/H50CFBACD/www/index.html";*/
/*
            ...
            public Object onCallBack(int pType, Object pArgs) {
                switch (pType) {
                    case IWebviewStateListener.ON_WEBVIEW_READY:
                        ...
                        iWebview.evalJS("", new ReceiveJSValue.ReceiveJSValueCallback() {
                            @Override
